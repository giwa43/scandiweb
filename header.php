            ...
            <nav id="primary-menu" class="navbar navbar-fixed-top">
                ...
                <span class="icon-bar"></span>
                 ...
                 <a class="logo" href="index.php">
                    <img src="assets/images/logo/bg1.png" height="150" width="150" alt="logo">
                    <!-- <strong style="color:#34495e; font-size:18px;">Blackgold Homes</strong> -->
                </a>
                    </div>
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane fade in active" id="login">
                                                        <div class="signup-form-container text-center">
                                                            <form class="mb-0" method="post" name="signin">
                                                                ...
                                                                <div class="or-text">
                                                                <span style="color: gold">BLACKGOLD ESTABLISHMENTS</span>
                                                            </div>
                                                    ...
                                                    <div class="tab-pane" id="signup">
                                                        <form class="mb-0" method="post" name="signup">
                                                            ...
                                                            <div class="or-text">
                                                                <span style="color: blue">BLACKGOLD ESTABLISHMENTS</span>
                                                            </div>
                                                            <div class="form-group">
